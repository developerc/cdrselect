        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (arrUsers.length == 0) {
                    ...
                    console.log('alredy there is admin')
                    $('#errLabel').text('Администратор у нас уже есть');
                    $('#errLabel').css("color", "red");
                }
            },
    ...
    var AuthUser = function () {
        $.ajax({
            ...
            success: function (result) {
                ...
                setTimeout( 'location="http://localhost:8080/setaccount";', 2000 );
